...
export interface RecurringEvent {id:number;user_id:number;user_name:string;user_color:string;text:string;start_date:string;interval:number;unit:'day'|'week'|'month'|'year';weekdays:number[];end_date:string|null;count:number|null;active_days:number|null;rest_days:number|null}
